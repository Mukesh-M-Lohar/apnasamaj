...
def upgrade() -> None:
    ...
    op.create_foreign_key(
        "fk_families_family_head_id_members", "families", "members", ["family_head_id"], ["id"], ondelete="SET NULL"
    )
    ...
    op.create_index(
        "ix_committee_members_tenant_active", "committee_members", ["tenant_id", "is_deleted"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "status", sa.Enum("OPEN", "IN_PROGRESS", "RESOLVED", "REJECTED", name="complaintstatus"), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column("currency", sa.String(length=3), nullable=False),
        sa.Column(
            "status", sa.Enum("PENDING", "SUCCEEDED", "FAILED", "REFUNDED", name="transactionstatus"), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status", sa.Enum("PENDING", "CONFIRMED", "CANCELLED", "COMPLETED", name="bookingstatus"), nullable=False
        ),
    ...
    op.create_index(
        "ix_facility_bookings_tenant_active", "facility_bookings", ["tenant_id", "is_deleted"], unique=False
    )
    ...
    op.create_index(
        "ix_event_registrations_tenant_active", "event_registrations", ["tenant_id", "is_deleted"], unique=False
    )
    ...
    op.create_index(
        "ix_volunteer_assignments_tenant_active", "volunteer_assignments", ["tenant_id", "is_deleted"], unique=False
    )
    op.create_index(op.f("ix_volunteer_assignments_tenant_id"), "volunteer_assignments", ["tenant_id"], unique=False)
    op.create_index(
        op.f("ix_volunteer_assignments_volunteer_id"), "volunteer_assignments", ["volunteer_id"], unique=False
    )
    op.create_table(
        "poll_options",
